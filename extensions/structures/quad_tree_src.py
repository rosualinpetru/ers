...
class QuadTreeSRC:
    # modified constructor to inject box and simulate linear
    def __init__(self, height: int, bounding_box: Rect, is_src: bool):
        self.max_domain = 2 ** height
        qdag = QuadTreeSRC._build_quad_tree_src_helper(height, bounding_box, is_src)
        qdag[QDAG_ROOT] = [bounding_box]
        self.is_src = is_src
